...
(function(root, mod) {
  ...
  Server.prototype = signal.mixin({
    ...
    request: function(doc, c) {
    	//this doc contains query json of the post call 
      var inv = invalidDoc(doc);
      if (inv) return c(inv);

      var self = this;
      //call goes to doRequest
  ...
  //here doc contains query details like type, file etc
  //srv is this(Server) object flowing from request call
